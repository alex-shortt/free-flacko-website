/* This File contains: OBJ Loader, MTL Loader, Orbit Controls, Touchswipe, Autosize, Picstrips, and Hashchange */

THREE.MTLLoader = function(e) {
    this.manager = void 0 !== e
        ? e
...
THREE.MTLLoader.prototype = {
    ...
    parse: function(e) {
        for (var t = e.split("\n"), n = {}, a = /\s+/, o = {}, r = 0; r < t.length; r++) {
            var i = t[r];
            if (0 !== (i = i.trim()).length && "#" !== i.charAt(0)) {
                var s = i.indexOf(" "),
                    c = s >= 0
                        ? i.substring(0, s)
                        : i;
        ...
        var u = new THREE.MTLLoader.MaterialCreator(this.texturePath || this.path, this.materialOptions);
...
THREE.MTLLoader.MaterialCreator.prototype = {
        ...
        for (var n in e) {
            ...
            for (var r in a) {
                ...
                switch (c) {
                    ...
                    case "ka":
                    case "ks":
                        this.options && this.options.normalizeRGB && (s = [
                            s[0] / 255,
                            s[1] / 255,
                            s[2] / 255
                        ]),
                        this.options && this.options.ignoreZeroRGBs && 0 === s[0] && 0 === s[1] && 0 === s[2] && (i = !1)
                }
                i && (o[c] = s)
            }
        }
    ...
    create: function(e) {
        return void 0 === this.materials[e] && this.createMaterial_(e),
        this.materials[e]
    },
    createMaterial_: function(e) {
        ...
        function n(e, n) {
            if (!r[e]) {
                var o = a.getTextureParams(n, r),
                    i = a.loadTexture(t(a.baseUrl, o.url));
                i.repeat.copy(o.scale),
                i.offset.copy(o.offset),
                i.wrapS = a.wrap,
                i.wrapT = a.wrap,
                r[e] = i
            }
        ...
        for (var i in o) {
            ...
            if ("" !== s)
                switch (i.toLowerCase()) {
                    case "kd":
                        r.color = (new THREE.Color).fromArray(s);
                        break;
                    case "ks":
                        r.specular = (new THREE.Color).fromArray(s);
                        break;
                    case "map_kd":
                        n("map", s);
                        break;
                    ...
                    case "ns":
                        ...
                        break;
                    case "d":
                        s < 1 && (r.opacity = s, r.transparent = !0);
                        break;
                    case "Tr":
                        s > 0 && (r.opacity = 1 - s, r.transparent = !0)
                }
            }
        return this.materials[e] = new THREE.MeshPhongMaterial(r),
        this.materials[e]
    },
    getTextureParams: function(e, t) {
        var n,
            ...
            o = e.split(/\s+/);
        return (n = o.indexOf("-bm")) >= 0 && (t.bumpScale = parseFloat(o[n + 1]), o.splice(n, 2)),
        (n = o.indexOf("-s")) >= 0 && (a.scale.set(parseFloat(o[n + 1]), parseFloat(o[n + 2])), o.splice(n, 4)),
        (n = o.indexOf("-o")) >= 0 && (a.offset.set(parseFloat(o[n + 1]), parseFloat(o[n + 2])), o.splice(n, 4)),
        a.url = o.join(" ").trim(),
        a
    },
    loadTexture: function(e, t, n, a, o) {
        var r,
            i = THREE.Loader.Handlers.get(e),
            s = void 0 !== this.manager
                ? this.manager
                : THREE.DefaultLoadingManager;
        return null === i && (i = new THREE.TextureLoader(s)),
        i.setCrossOrigin && i.setCrossOrigin(this.crossOrigin),
        r = i.load(e, n, a, o),
        void 0 !== t && (r.mapping = t),
        r
    }
},
...
THREE.OBJLoader.prototype = {
    ...
    load: function(e, t, n, a) {
        var o = this,
            r = new THREE.FileLoader(o.manager);
        r.setPath(this.path),
        r.load(e, function(e) {
            t(o.parse(e))
        }, n, a)
    ...
    _createParserState: function() {
        var e = {
            ...
            startObject: function(e, t) {
                ...
                var n = this.object && "function" == typeof this.object.currentMaterial
                ...
                if (this.object && "function" == typeof this.object._finalize && this.object._finalize(!0), this.object = {
                    ...
                    startMaterial: function(e, t) {
                        ...
                        var a = {
                            ...
                            name: e || "",
                            mtllib: Array.isArray(t) && t.length > 0
                                ? t[t.length - 1]
                                : "",
                            smooth: void 0 !== n
                                ? n.smooth
                    ...
                    return e && 0 === this.materials.length && this.materials.push({name: "", smooth: this.smooth}),
                        t
                    }
            ...
            addFace: function(e, t, n, a, o, r, i, s, c, h, l, u) {
                var d,
                    p = this.vertices.length,
                    m = this.parseVertexIndex(e, p),
                    E = this.parseVertexIndex(t, p),
                    f = this.parseVertexIndex(n, p);
                if (
                    void 0 === a
                    ? this.addVertex(m, E, f)
                    : (d = this.parseVertexIndex(a, p), this.addVertex(m, E, d), this.addVertex(E, f, d)),
                void 0 !== o) {
                    var b = this.uvs.length;
                    m = this.parseUVIndex(o, b),
                    E = this.parseUVIndex(r, b),
                    f = this.parseUVIndex(i, b),
                    void 0 === a
                        ? this.addUV(m, E, f)
                        : (d = this.parseUVIndex(s, b), this.addUV(m, E, d), this.addUV(E, f, d))
                }
                if (void 0 !== c) {
                    ...
                    E = c === h
                        ? m
                        : this.parseNormalIndex(h, g),
                    f = c === l
                        ? m
                        : this.parseNormalIndex(l, g),
                    void 0 === a
                        ? this.addNormal(m, E, f)
                        : (d = this.parseNormalIndex(u, g), this.addNormal(m, E, d), this.addNormal(E, f, d))
                }
            },
            addLineGeometry: function(e, t) {
                this.object.geometry.type = "Line";
                for (var n = this.vertices.length, a = this.uvs.length, o = 0, r = e.length; o < r; o++)
                    this.addVertexLine(this.parseVertexIndex(e[o], n));
                for (var i = 0, r = t.length; i < r; i++)
                    this.addUVLine(this.parseUVIndex(t[i], a))
            }
        };
    ...
    parse: function(e) {
        ...
        -1 !== e.indexOf("\r\n") && (e = e.replace(/\r\n/g, "\n")),
        -1 !== e.indexOf("\\\n") && (e = e.replace(/\\\n/g, ""));
        for (var n = e.split("\n"), a = "", o = "", r = "", i = [], s = "function" == typeof "".trimLeft, c = 0, h = n.length; c < h; c++)
            if (
                a = n[c], a = s
                ? a.trimLeft()
                : a.trim(),
            0 !== a.length && "#" !== (o = a.charAt(0)))
                if ("v" === o)
                    if (" " === (r = a.charAt(1)) && null !== (i = this.regexp.vertex_pattern.exec(a)))
                        t.vertices.push(parseFloat(i[1]), parseFloat(i[2]), parseFloat(i[3]));
                    else if ("n" === r && null !== (i = this.regexp.normal_pattern.exec(a)))
                        t.normals.push(parseFloat(i[1]), parseFloat(i[2]), parseFloat(i[3]));
                    else {
                        if ("t" !== r || null === (i = this.regexp.uv_pattern.exec(a)))
                            throw new Error("Unexpected vertex/normal/uv line: '" + a + "'");
                        t.uvs.push(parseFloat(i[1]), parseFloat(i[2]))
                    }
                else if ("f" === o)
            if (null !== (i = this.regexp.face_vertex_uv_normal.exec(a)))
                t.addFace(i[1], i[4], i[7], i[10], i[2], i[5], i[8], i[11], i[3], i[6], i[9], i[12]);
            else if (null !== (i = this.regexp.face_vertex_uv.exec(a)))
                t.addFace(i[1], i[3], i[5], i[7], i[2], i[4], i[6], i[8]);
            else if (null !== (i = this.regexp.face_vertex_normal.exec(a)))
                t.addFace(i[1], i[3], i[5], i[7], void 0, void 0, void 0, void 0, i[2], i[4], i[6], i[8]);
            else {
                if (null === (i = this.regexp.face_vertex.exec(a)))
                    throw new Error("Unexpected face line: '" + a + "'");
                t.addFace(i[1], i[2], i[3], i[4])
            }
        else if ("l" === o) {
            var l = a.substring(1).trim().split(" "),
                u = [],
                d = [];
            if (-1 === a.indexOf("/"))
                u = l;
        ...
        } else if (null !== (i = this.regexp.object_pattern.exec(a))) {
            var f = (" " + i[0].substr(1).trim()).substr(1);
            t.startObject(f)
            ...
            if (null === (i = this.regexp.smoothing_pattern.exec(a))) {
                if ("\0" === a)
                    continue;
                throw new Error("Unexpected line: '" + a + "'")
            }
            var b = i[1].trim().toLowerCase();
            t.object.smooth = "1" === b || "on" === b,
            (j = t.object.currentMaterial()) && (j.smooth = t.object.smooth)
        }
        t.finalize();
        var g = new THREE.Group;
        g.materialLibraries = [].concat(t.materialLibraries);
        for (var c = 0, h = t.objects.length; c < h; c++) {
            var v = t.objects[c],
                T = v.geometry,
                R = v.materials,
                x = "Line" === T.type;
            if (0 !== T.vertices.length) {
                ...
                y.addAttribute("position", new THREE.BufferAttribute(new Float32Array(T.vertices), 3)),
                T.normals.length > 0
                    ? y.addAttribute("normal", new THREE.BufferAttribute(new Float32Array(T.normals), 3))
                    : y.computeVertexNormals(),
                T.uvs.length > 0 && y.addAttribute("uv", new THREE.BufferAttribute(new Float32Array(T.uvs), 2));
                for (var H = [], w = 0, O = R.length; w < O; w++) {
                    var L = R[w],
                        j = void 0;
                    if (null !== this.materials && (j = this.materials.create(L.name), x && j && !(j instanceof THREE.LineBasicMaterial))) {
                    ...
                    j || ((
                        ...
                        : new THREE.MeshPhongMaterial).name = L.name),
                    j.shading = L.smooth
                        ? THREE.SmoothShading
                        : THREE.FlatShading,
                    H.push(j)
                ...
                var P;
                if (H.length > 1) {
                    for (var w = 0, O = R.length; w < O; w++) {
                        L = R[w];
                        y.addGroup(L.groupStart, L.groupCount, w)
                    }
                    P = x
                        ? new THREE.LineSegments(y, H)
                        : new THREE.Mesh(y, H)
                } else
                    P = x
                        ? new THREE.LineSegments(y, H[0])
                        : new THREE.Mesh(y, H[0]);
                P.name = v.name,
                g.add(P)
            }
        }
...
THREE.OrbitControls = function(e, t) {
    ...
    function i(e) {
        _.object instanceof THREE.PerspectiveCamera
            ? z /= e
            : _.object instanceof THREE.OrthographicCamera
                ? (_.object.zoom = Math.max(_.minZoom, Math.min(_.maxZoom, _.object.zoom * e)), _.object.updateProjectionMatrix(), Z = !0)
                : (console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."), _.enableZoom = !1)
    }
    function s(e) {
        _.object instanceof THREE.PerspectiveCamera
            ? z *= e
    ...
    function u(e) {
        ...
        G.subVectors(X, Y);
        var t = _.domElement === document
            ? _.domElement.body
            : _.domElement;
        o(2 * Math.PI * G.x / t.clientWidth * _.rotateSpeed),
        r(2 * Math.PI * G.y / t.clientHeight * _.rotateSpeed),
        Y.copy(X),
        _.update()
    }
    function d(e) {
    ...
    function H(e) {
        if (!1 !== _.enabled) {
            ...
            N !== U.NONE && (document.addEventListener("mousemove", w, !1), document.addEventListener("mouseup", O, !1), _.dispatchEvent(V))
        }
    }
    function w(e) {
        if (!1 !== _.enabled)
    ...
    function O(e) {
        !1 !== _.enabled && (m(e), document.removeEventListener("mousemove", w, !1), document.removeEventListener("mouseup", O, !1), _.dispatchEvent(F), N = U.NONE)
    }
    function L(e) {
        !1 === _.enabled || !1 === _.enableZoom || N !== U.NONE && N !== U.ROTATE || (e.preventDefault(), e.stopPropagation(), E(e), _.dispatchEvent(V), _.dispatchEvent(F))
    }
    function j(e) {
        !1 !== _.enabled && !1 !== _.enableKeys && !1 !== _.enablePan && f(e)
    }
    function M(e) {
        if (!1 !== _.enabled) {
    ...
    function C(e) {
        !1 !== _.enabled && (y(e), _.dispatchEvent(F), N = U.NONE)
    }
    function A(e) {
        e.preventDefault()
    }
    this.object = e,
    this.domElement = void 0 !== t
        ? t
        : document,
    this.enabled = !0,
    ...
    this.update = function() {
        ...
        return function() {
            var e = _.object.position;
            return t.copy(e).sub(_.target),
            t.applyQuaternion(a),
            S.setFromVector3(t),
            _.autoRotate && N === U.NONE && o(n()),
            S.theta += D.theta,
            S.phi += D.phi,
            S.theta = Math.max(_.minAzimuthAngle, Math.min(_.maxAzimuthAngle, S.theta)),
            S.phi = Math.max(_.minPolarAngle, Math.min(_.maxPolarAngle, S.phi)),
            S.makeSafe(),
            S.radius *= z,
            S.radius = Math.max(_.minDistance, Math.min(_.maxDistance, S.radius)),
            _.target.add(B),
            t.setFromSpherical(S),
            t.applyQuaternion(r),
            e.copy(_.target).add(t),
            _.object.lookAt(_.target),
            !0 === _.enableDamping
                ? (D.theta *= 1 - _.dampingFactor, D.phi *= 1 - _.dampingFactor)
                : D.set(0, 0, 0),
            z = 1,
            B.set(0, 0, 0),
            !!(Z || i.distanceToSquared(_.object.position) > I || 8 * (1 - s.dot(_.object.quaternion)) > I) && (_.dispatchEvent(k), i.copy(_.object.position), s.copy(_.object.quaternion), Z = !1, !0)
        }
    }(),
    this.dispose = function() {
        _.domElement.removeEventListener("contextmenu", A, !1),
        _.domElement.removeEventListener("mousedown", H, !1),
        _.domElement.removeEventListener("wheel", L, !1),
        _.domElement.removeEventListener("touchstart", M, !1),
        _.domElement.removeEventListener("touchend", C, !1),
        _.domElement.removeEventListener("touchmove", P, !1),
    ...
    var _ = this,
        ...
        ne = function() {
            var e = new THREE.Vector3;
            return function(t, n) {
                var a = _.domElement === document
                    ? _.domElement.body
                    : _.domElement;
                if (_.object instanceof THREE.PerspectiveCamera) {
                    var o = _.object.position;
                    e.copy(o).sub(_.target);
                    var r = e.length();
                    r *= Math.tan(_.object.fov / 2 * Math.PI / 180),
                    ee(2 * t * r / a.clientHeight, _.object.matrix),
                    te(2 * n * r / a.clientHeight, _.object.matrix)
                } else
                    _.object instanceof THREE.OrthographicCamera
                        ? (ee(t * (_.object.right - _.object.left) / _.object.zoom / a.clientWidth, _.object.matrix), te(n * (_.object.top - _.object.bottom) / _.object.zoom / a.clientHeight, _.object.matrix))
                        : (console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."), _.enablePan = !1)
                }
        }();
    _.domElement.addEventListener("contextmenu", A, !1),
    _.domElement.addEventListener("mousedown", H, !1),
    _.domElement.addEventListener("wheel", L, !1),
    _.domElement.addEventListener("touchstart", M, !1),
    _.domElement.addEventListener("touchend", C, !1),
    _.domElement.addEventListener("touchmove", P, !1),
    ...
    function TouchSwipe(element, options) {
            ...
            if (!(getTouchInProgress() || $(jqEvent.target).closest(options.excludedElements, $element).length > 0)) {
                ...
                if (!event.pointerType || "mouse" != event.pointerType || 0 != options.fallbackToMouseEvents) {
                    ...
                    !touches || fingerCount === options.fingers || options.fingers === ALL_FINGERS || hasPinches()
                        ? (startTime = getTimeStamp(), 2 == fingerCount && (createFingerData(1, touches[1]), startTouchesDistance = endTouchesDistance = calculateTouchesDistance(fingerData[0].start, fingerData[1].start)), (options.swipeStatus || options.pinchStatus) && (ret = triggerHandler(event, phase)))
                        : ret = !1,
                    ret === !1
        ...
        function touchMove(jqEvent) {
            ...
            if (phase !== PHASE_END && phase !== PHASE_CANCEL && !inMultiFingerRelease()) {
                ...
                if (endTime = getTimeStamp(), touches && (fingerCount = touches.length), options.hold && clearTimeout(holdTimeout), phase = PHASE_MOVE, 2 == fingerCount && (
                ...
                pinchDistance = Math.abs(startTouchesDistance - endTouchesDistance)), fingerCount === options.fingers || options.fingers === ALL_FINGERS || !touches || hasPinches()) {
        ...
        function triggerHandlerForGesture(event, phase, gesture) {
            ...
            return gesture == TAP
                ? phase !== PHASE_CANCEL && phase !== PHASE_END || (
                    ...
                    ? (doubleTapStartTime = getTimeStamp(), singleTapTimeout = setTimeout($.proxy(function() {
